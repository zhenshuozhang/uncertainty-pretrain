...
from pretrain.utils.dataloader import DataLoaderMasking #, DataListLoader
...
from utils.util import MaskAtom
...
def main():
    ...
    dataset = MoleculeDataset("/data/zzs/chem-dataset/dataset/" + args.dataset, dataset=args.dataset, transform = MaskAtom(num_atom_type = 119, num_edge_type = 5, mask_rate = args.mask_rate, mask_edge=args.mask_edge))
