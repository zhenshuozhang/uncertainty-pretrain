...
def main():
    ...
    #set up dataset
    print(args.dataset)
    dataset = MoleculeDataset_aug("/home1/zzs/chem-dataset/dataset/" + args.dataset, dataset=args.dataset)
    print(dataset)
    """
    # sample
    if args.sub_ratio < 1:
    ...
    for epoch in range(1, args.epochs):
        ...
        #train_acc, train_loss = train(args, model, device, sub_dataset, optimizer)
